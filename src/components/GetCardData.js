...
console.log(data);
  ...
  <div>
    {data.map((card)=>{
        return <div key={card?.card?.info?.id} className=" flex justify-between relative  my-2 pt-4  border-gray-400 shadow-md border-b-2">
             <div className="w-3/4 text-left">
              ...
              <div className="h-52 w-3/12   items-center justify-center relative ">
